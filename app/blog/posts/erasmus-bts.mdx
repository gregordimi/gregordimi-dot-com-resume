...
Bayesian truth serum is a methodology for eliciting subjective judgments and "unverifiable truths", developed by an MIT professor [^prelec2004bayesian]. Prelec recognizes the necessity of assessing subjective beliefs in absence of objective truth as opinions, attitudes, and intentions are often used in science and policymaking.
...
[^prelec2004bayesian6] relies on several assumptions for constructing BTS algorithm:


Bayesian Nash equilibrium

"Truth-telling is individually and collectively optimal"[^prelec2004bayesian7]. Taking into account the BTS assumptions, agents stating their true preferences is BTS Nash equilibrium for any α>0. Thus, it is individually optimal as BTS Nash equilibrium results in a maximum expected payoff. It is collectively optimal because there is no other equilibrium which results in a higher information score for any agent. The equilibrium relies on two assumptions:
...
[^prelec2004bayesian3]: 2004 A Bayesian Truth Serum For Subjective Data
[^prelec2004bayesian4]: 2004 A Bayesian Truth Serum For Subjective Data
[^prelec2004bayesian5]: 2004 A Bayesian Truth Serum For Subjective Data
[^prelec2004bayesian6]: 2004 A Bayesian Truth Serum For Subjective Data
[^prelec2004bayesian7]: 2004 A Bayesian Truth Serum For Subjective Data
[^prelec2004bayesian8]: 2004 A Bayesian Truth Serum For Subjective Data
[^ross1977false]: 1977 The “false Consensus Effect”: An Egocentric Bias In Social Perception And Attribution Processes
[^ross1977false2]: 1977 The “false Consensus Effect”: An Egocentric Bias In Social Perception And Attribution Processes
[^ross1977false3]: 1977 The “false Consensus Effect”: An Egocentric Bias In Social Perception And Attribution Processes
[^dawes1989statistical]: 1989 Statistical Criteria For Establishing A Truly False Consensus Effect
[^dawes1989statistical2]: 1989 Statistical Criteria For Establishing A Truly False Consensus Effect
[^barrage2010penny]: 2010 A Penny For Your Thoughts: Inducing Truth-telling In Stated Preference Elicitation
[^barrage2010penny2]: 2010 A Penny For Your Thoughts: Inducing Truth-telling In Stated Preference Elicitation
[^howie2011predicting]: 2011 Predicting New Product Adoption Using Bayesian Truth Serum
[^howie2011predicting2]: 2011 Predicting New Product Adoption Using Bayesian Truth Serum
[^weaver2013creating]: 2013 Creating Truth-telling Incentives With The Bayesian Truth Serum
[^weaver2013creating2]: 2013 Creating Truth-telling Incentives With The Bayesian Truth Serum
[^john2012measuring]: 2012 Measuring The Prevalence Of Questionable Research Practices With Incentives For Truth Telling
[^kukla2015we]: 2015 We All Do It, But Are We Willing To Admit? Incentivizing Digital Pirates’ Confessions